                    ...
                    <View className="form space-y-7 mt-8">
                        <View className="mt-2">
                            <TextInput
                                ...
                                placeholder='>>'
                            />
                            <Text className="absolute ml-6 bg-white -top-4 text-black text-xl text-green-700">Email Name</Text>
                        </View>
                        <View>
                            <TextInput
                                className="p-3 pl-6 rounded-xl mb-3 border border-green-600 text-black text-lg"
                            ...
                            <TouchableOpacity className="flex-row-reverse ml-2"><Text className="text-green-700 font-bold">Forget Password</Text></TouchableOpacity>
                        </View>
